...
const { ref, inView } = useInView({
  ...
  return (
    ...
    {loader ? <div className='flex flex-col gap-[2rem] h-[100vh] w-[100vw] items-center justify-center'>
    ...
    <div class="loader"></div>
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            <div>
              <div className="lg:w-[570px]">
                ...
                {/* <Link to="/login"> */}
                  <button onClick={AppointmentRequest} className="btn ">Request an Appointment</button>
                {/* </Link> */}
                {
                  isUserLoggedIn && <button className="btn ">Appointment Status</button>
                }
              </div>
      ...
      <div className="container">
        ...
        >
          {/*  Card 1 */}
          <motion.div
            className="py-[30px] px-5 w-[400px]"
          ...
          >
            ...
            <div className="mt-[10px]">
              ...
              <Link to="/login" className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none">
                <BsArrowBarRight className="group-hover:text-white w-6 h-5" />
              </Link>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-[10px]"  onClick={() => window.location.href = "https://maps.app.goo.gl/cB3FTihgeeU9ngQw5"} >
